...
$removecourse=$_POST['id'];

$conn=mysqli_connect('localhost','root','','onlineclassses');
$query= "SELECT video FROM items where id='$removecourse'";
$result=mysqli_query($conn,$query);
    while($row=mysqli_fetch_assoc($result)){
     ...
     ?>
	<iframe allow='autoplay' width="600" height="400" src=" <?php echo $video ; ?>" frameborder="0" autoplay allowfullscreen></iframe>
