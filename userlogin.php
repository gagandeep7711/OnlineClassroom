  ...
  <div class="row">
    <div class="col-md-5 mx-auto my-4">
      <div class="card card-signup z-depth-0">
        ...
        <h2 style="border-bottom:1px solid #3E065F; color:#3E065F;">Online Classroom Website</h2>
		 <div class="card-foter text-right"  style="margin-top:20px;">
		 <form method="POST" action="index.php">
  		    <input type="submit" class="btn " id="home" value="Home" style="width: 140px; background-color:#3E065F; color:#ffffff;"></button>
          </div>
          ...
          <div class="card-foter text-right"  style="margin-top:20px;">
  		    <button type="button" class="btn " id="done" style="width: 140px; background-color:#3E065F; color:#ffffff;" onclick="document.getElementById('myloginform').submit();">Sign In</button>
          </div>
		  </form>

		  <div class="card-foter"  style="margin-top:20px;border-top:1px solid #3E065F;font-size:large">
  		    <a href="usersignup.php" id="newaccount" style="color:#3E065F;">Don't have account?</a>

      <div class="forgot">
							<a href="forgot-password.php" id="forgetpassword" style="color:#3E065F;">Forgot password?</a>
						</div>
