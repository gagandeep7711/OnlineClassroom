...
<div class="" style="width: 100%;padding-bottom:2%;float:right;display:block">
  ...
  <input style="float:left;display:inline-block;width:auto; background-color:#3E065F;color:#ffffff;" name="delete" type="button" class="btn "  data-toggle="modal" data-target=".bd-example-modal-lg" value="Delete" ></div>
  </div>
  </div>
</div>
</div>
		...
		<div class="modal fade bd-example-modal-lg" id="modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
			<div class="modal-dialog modal-lg">
				<div class="modal-content" style="display:inline-block;padding:20px;">
					...
					<button name="no" class="btn border-dark" data-dismiss="modal" type="button" style="float:left;width:40%;display:inline-block;" >NO</button>
					<input name="yes" type="submit" style="float:right;width:40%;display:inline-block;" class="pic btn btn-outline-dark" value="Yes" >
					</form>
				</div>
			</div>
		</div>
