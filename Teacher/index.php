...
<body><link rel="stylesheet" href="../../../../images/demobar_w3_4thDec2019.css">
  ...
  <div id="w3lDemoBar" class="w3l-demo-bar" style="background:#3E065F;">
    ...
    <span class="w3l-text" style ="font-size: x-large;color:white;padding-left:2%;"  > Online Classes Website Teacher</span>
    	 ...
    	 <div class="login-head">
			...
			<div class="login-block" >
  		    ...
  		    <a href="usersignup.php" id="newaccount" style="color:#3E065F;">Don't have account?</a>
				...
				<h5><a href="../index.php" id="home" style="color:#3E065F">Go Back to Home</a></h5>
			</div>
      </div>
</div>
