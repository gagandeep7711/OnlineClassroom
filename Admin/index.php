...
<body><link rel="stylesheet" href="../../../../images/demobar_w3_4thDec2019.css">
  ...
  <div id="w3lDemoBar" class="w3l-demo-bar" style="background:#3E065F;">
    ...
    <span class="w3l-text" style ="font-size: x-large;color:white;padding-left:2%;"  > Online Classes Website Admin</span>
    ...
    <div class="login-main" style="margin-top:0px;border-radius:12px;">  	
    	 <div class="login-head">
			...
			<div class="login-block" >
				...
				<h5><a href="../index.php" name="backhome" style="color:#3E065F">Go Back to Home</a></h5>
			</div>
      </div>
</div>
