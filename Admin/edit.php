...
<div class="card border-dark mb-3" style="max-width: 50%;float:left;">
  <div class="card-header" style="float:left;"><h5 style="text-align:center;">Teacher</h5> <h3  style="float:right;display:inline-block;"><input name="teacher" style="width:100%" value="<?php echo $teacher; ?>"></h3></div>
</div>
<div class="card border-dark  mb-3" style="max-width: 50%;float:right;">
