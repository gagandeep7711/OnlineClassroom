...
$query1="SELECT * FROM `users`";
	...
	<input type="text" class="form-control" Placeholder="Enter Expiry date :" name="exdate" required>
	
		<label style="text-align:start"> CVV.:</label>
	<input type="text" class="form-control" Placeholder="Enter cvv:" name="cvv" required>
...
<small style="text-align:center;width:100%;"></small>
							...
							echo '<hr>
								...
								<div class="col-md-3">
									...
									<small style="text-align:end;">'.$row['date'].'</small>
										...
										<h5 style="color:#3E065F;">Course price '.$row2['price'].'<small style="font-family:verdana;font-size:small">$</small></h5>
									</div>
								</div>
