...
<h6 style="text-align:center;width:100%;border-top:1px solid black;border-bottom:1px solid black;" class="card-header" >My Course</h6>
					...
					<?php
																					...
																					$result=mysqli_query($conn,$query);
																						while($row=mysqli_fetch_assoc($result))
																						{
																							...
																							<form action="download.php" method="POST" style="display:block;">
																							<input type="text" value="'.$row['id'].'" style="display:none;" name="id">
					
		<input type="submit" class="btn btn-success" value=" View" style="width:100%;text-align:center;font-size:x-large;border-radius:0%;" >
																							</form>	
																							
																							<br>
																							<form action="removecourse.php" method="POST" style="display:block;">
																							<input type="text" value="'.$row['id'].'" style="display:none;" name="removecourse">
						
		<input type="submit" class="btn btn-success" value=" Remove Course" style="width:100%;text-align:center;font-size:x-large;border-radius:0%;" >
																							</form>	
...
<div >
	<h6 style="color:#fff;">Address</h6>
		<small style="color:#ffffff">Study with us<br>
		Montreal<br>
		Canada</small>
	</div>
</div>
