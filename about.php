...
<hr>
 <br>
 <div class="well">
<h4 style="text-align:center;">Online Classroom Web Application basically designed for college students and teachers in which students can enroll in any course depending upon different categories like Engineering,Medical,Arts,etc and teachers can upload the courses accordingly. Apart from this,teachers can manage the price of their courses and students  pay it accordingly. However, Admin manage students, teachers, upload new course categories as well manage prices of courses.
</h4>
<div class="col-md-12" >
<h5>The Online Classroom website involves three types of Users:
...
<h5>
The Administrator plays a vital role in the Online Classroom website.The administrator controls the entire database.The main role of the Administrator is safeguard the database and can add/delete/update the student and teacher from the database.Moreover,it also includes verifying student and teacher details.Its also adjust the courses price too.
...
The main role of the teacher is to Upload their course Lectures and upload the requested pdf too.Besides this, Teachers can upload their Courses prices as well as they revert the student queries too.
...
<h5>
The student can login and register to the System.He/she can enroll in any courses or view or download the document.The student can download the document whereas he/she could not make changes in the database.The student can pay enrollment fees too.Apart from this,Student can write a queries to teacher about their courses.
