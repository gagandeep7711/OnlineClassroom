...
<h2 style="text-align:center;width:100%;border-top:1px solid black;border-bottom:1px solid black;margin-bottom:5px;" class="card-header" ><i class="fa fa-shopping-cart" style="font-size:x-large;" aria-hidden="true"></i> My Profile </h2>
...
<div class="col-md-5" style="text-align:end;">
	...
	<div class="card-body">
		<label style="text-align:start"> User Name.:</label>
	<input type="text" class="form-control" Placeholder="Enter Username no.:" disabled name="username" value="<?php echo $username; ?>" required>
		<label style="text-align:start"> Email.:</label>
	<input type="text" class="form-control" Placeholder="Enter Email :"  name="email" disabled value="<?php echo $email; ?>" required>
		<label style="text-align:start"> Password:</label>
	<input type="text" class="form-control" Placeholder="Enter password no.:" name="password" value="<?php echo $pass; ?>" required>
	<label style="text-align:start"> Card No.:</label>
	<input type="text" class="form-control" Placeholder="Enter card no.:" name="trans_id" value="<?php echo $card_number?>" required>
			<label style="text-align:start"> Expiry Date:</label>
	<input type="text" class="form-control" Placeholder="Enter Expiry date :" name="exdate" value="<?php echo $ex_date; ?>" required>
	
		<label style="text-align:start"> CVV.:</label>
	<input type="text" class="form-control" Placeholder="Enter cvv:" name="cvv" value="<?php echo $cvv; ?>" required>
	

	</div>
	</div>
	<br>
	<input type="submit" style="text-align:center;width:100%;font-size:x-large;border-radius:1%; background-color:#3E065F; color:#ffffff;" class="btn " value="Update now">
	</form>
